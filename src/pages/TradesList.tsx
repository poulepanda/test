...
export default function TradesList() {
  ...
  return (
    <div className="p-6">
      <div className="mb-8">
        <h1 className="text-2xl font-bold mb-6">Trades List</h1>
        
        {/* Filters */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-gray-800 p-6 rounded-lg mb-6">
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-gray-800 p-4 rounded-lg">
            <div className="text-gray-400 text-sm">Status Distribution</div>
